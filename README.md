...
| BASE64 | `^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{4}\|[A-Za-z0-9+\/]{3}=\|[A-Za-z0-9+\/]{2}==)$` | [Regex101](https://regex101.com/r/mEaBsx/1) | [issue #3](https://github.com/AndrewRathbun/DFIRRegex/issues/3) |
